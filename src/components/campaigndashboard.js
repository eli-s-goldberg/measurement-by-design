              ...
              return html`
                <div>
                  ...
                  >
                    ...
                    <div class="table-cell">${formatNumber(
                      campaign.population?.size
                    )}</div>
                    <div class="table-cell">${formatValue(
                      "cost",
                      campaign.metrics?.costPerChange?.value || 0
                    )}</div>
                    <div class="table-cell">${formatValue(
                      "totalImpact",
                      campaign.metrics?.totalImpact?.value || 0
                    )}</div>
                    <div class="table-cell">${formatValue(
                      "financialImpact",
                      campaign.metrics?.financialImpact?.value || 0
                    )}</div>
                    <div class="table-cell">${
                      campaign.metrics?.financialImpact?.pValue ||
                      campaign.metrics?.totalImpact?.pValue ||
                      "N/A"
                    }</div>
                  </div>
                      ...
                      ? html`
                          <div class="campaign-content">
                            <div class="section">
                              ...
                              <ul>
                                ${campaign.behaviorLevers?.map(
                                  (lever) => html`<li>${lever}</li>`
                                )}
                              </ul>
                            </div>
                            ...
                            <div class="section">
                              ...
                              <ul>
                                ${campaign.fundamentalAssumptions?.map(
                                  (assumption) => html`<li>${assumption}</li>`
                                )}
                              </ul>
                            </div>
                            ...
                            <div class="section">
                              ...
                              <div class="table-wrapper">
                                <div
                                  class="campaign-header metrics-header table-header"
                                >
                                ...
                                ${Object.entries(campaign.metrics).map(
                                  ([key, metric]) => html`
                            ...
                            ${campaign.priorVersions?.length
                              ? html`
                                  <div class="section">
                                    <h4>Prior Versions</h4>
                                    <div class="table-wrapper">
                                      <div
                                        class="campaign-header prior-header table-header"
                                      >
                                        <div class="version-cell">Version</div>
                                      ...
                                      ${campaign.priorVersions.map(
                                        (prev) => html`
                                          <div
                                            class="campaign-header prior-header"
                                          >
                                            <div class="table-cell">
                                              ${prev.version}
                                            </div>
                                            ...
                                            <div class="table-cell">
                                              ${prev.metrics.engagementRate
                                                ?.value}%
                                            </div>
                                            <div class="table-cell">
                                              ${formatNumber(
                                                prev.metrics.totalImpact?.value
                                              )}
                                            </div>
                                          </div>
                                        `
