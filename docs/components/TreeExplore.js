...
export function createTreeWithStats(data, columnOrder, columnMapper, stroke_width_divisor = 100) {
  ...
  mainContainer.style.width = '100%'; // Added to ensure full width
...
function createCollapsibleTree(data, width = 800, height = 800, updateStats, clearStats, stroke_width_divisor = 100) {
  const treeContainer = document.createElement('div');
  treeContainer.style.overflow = 'auto';
  treeContainer.style.height = '80%';
  ...
  const svg = d3.create("svg")
    ...
    .style("font", "arial 12px sans-serif")
